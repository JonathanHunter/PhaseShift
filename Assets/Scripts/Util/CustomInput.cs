namespace PhaseShift.Util
{
    ...
    public class CustomInput : MonoBehaviour
    {
        ...
        {
            Up, Down, Left, Right, Shoot1, Shoot2, Jump, Panic, Pause, Accept, Cancel, LookUp, LookDown, LookLeft, LookRight
        }
        ...
        public static void RawSign()
        {
            ...
            rawSign[(int)UserInput.Shoot1] = 1;
            rawSign[(int)UserInput.Shoot2] = 1;
            rawSign[(int)UserInput.Jump] = 1;
            rawSign[(int)UserInput.Panic] = 1;
        ...
        public static void DefaultKey()
        {
            ...
            keyboard[(int)UserInput.Shoot1, 0] = KeyCode.Mouse0;
            keyboard[(int)UserInput.Shoot2, 0] = KeyCode.Mouse1;
            keyboard[(int)UserInput.Panic, 0] = KeyCode.E;
        ...
        public static void DefaultPad()
        {
            ...
            gamepad[(int)UserInput.Shoot1, 0] = LEFT_TRIGGER;
            gamepad[(int)UserInput.Shoot2, 0] = RIGHT_TRIGGER;
            gamepad[(int)UserInput.Panic, 0] = X;
